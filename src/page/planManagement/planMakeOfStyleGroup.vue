  ...
  <div class="body">
    <el-card class="box-card">
      ...
      >
        <!-- title -->
        <el-row :gutter="20">
          <span class="Mtitle" v-if="isCreatePlanFlag || isModifyPlanFlag">款式组计划制定</span>
          <span class="Mtitle" v-else>款式组计划详情</span>
        </el-row>

        <el-row :gutter="20">
          <el-col :span="8">
            <div class="bar">
              <el-form-item label="款式组名" prop="styleGroupName" placeholder="请输入">
                <el-input
                  v-model="ruleForm.styleGroupName"
                  :rows="1"
                  placeholder="请选择"
  ...
  data() {
    return {
      ...
      ruleForm: {
        ...
        extension: "无数据",
        executionState: "无数据",
        startEndDate: ["2020-02-14", "2020-02-15"],

  ...
  <div class="body">
    <el-card class="box-card">
      ...
      >
        <!-- title -->
        <el-row :gutter="20">
          <span class="Mtitle" v-if="isCreatePlanFlag || isModifyPlanFlag">系列计划制定</span>
          <span class="Mtitle" v-else>系列计划详情</span>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="8">
            <div class="bar">
    ...
    */
        ...
        if (valid) {
          ...
          if (this.isRootPlanFlag) {
            ...
            request.put(`/root-plan/update`, param).then(response => {
              // 如果更新成功，则将原始计划数据开始日期，结束日期，日期，日期类型和投入点字段在本地更新
    ...
    processOnePlanData() {
      ...
      if (that.isCreatePlanFlag) {
        ...
        // 根据规则自动生成计划名 = 品牌名+波段+订单阶段+下发计划类型
        that.ruleForm.name =
